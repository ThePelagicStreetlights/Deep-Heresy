...
start:
  ...
  br i1 %0, label %panic.i, label %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h99a2c8c4d779e4dcE.exit"

panic.i:                                          ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h45b21bbabb0bd5a3E(ptr align 1 @str.0, i64 25, ptr align 8 @alloc4) #3
  unreachable

"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h99a2c8c4d779e4dcE.exit": ; preds = %start
  ret void
}
...
declare void @_ZN4core9panicking5panic17h45b21bbabb0bd5a3E(ptr align 1, i64, ptr align 8) unnamed_addr #2
